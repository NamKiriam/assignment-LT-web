...
<head>
    ...
    <meta name="description" content="Hỏi đáp - Giải đáp thắc mắc về đặt món ăn">
    <meta name="keywords" content="hỏi đáp, faq, đặt món, meal order">
    <title>Hỏi Đáp</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse header-tab-item fw-bold" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/Trang thực đơn/index.html">Thực đơn</a></li>
                        <li class="nav-item"><a class="nav-link" href="#">Bài viết</a></li>
                        <li class="nav-item"><a class="nav-link" href="/Trang giới thiệu/index.html">Giới thiệu</a></li>
            ...
            <div class="question-section">
                <div class="question-box">
                    <form id="question-form">
                        ...
                        <div class="mb-3">
                            <textarea name="question" class="form-control" rows="5" placeholder="Câu hỏi của tôi..." required></textarea>
                        </div>
...
<!-- Main JavaScript (dùng module) -->
<script type="module" src="displayQuestion.js"></script>
